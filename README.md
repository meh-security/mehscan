...
```sh
bash ./skills/mehscan-security/scripts/install-mehscan.sh --version 0.5.1
```

Windows:

```powershell
pwsh -NoProfile -File ./skills/mehscan-security/scripts/install-mehscan.ps1 -Version 0.5.1
```
...
- [Latest release notes](docs/release-notes-v0.5.1.md)
